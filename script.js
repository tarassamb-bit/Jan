...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Download button dropdown (show other OS options)
  const downloadExtra = document.querySelector('.hero-download-extra');
  if (downloadExtra) {
    downloadExtra.addEventListener('click', (e) => {
      e.preventDefault();
      // Could show a dropdown with Windows/Linux options
    });
  }
});
